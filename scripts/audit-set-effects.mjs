...
const STATUS_OVERRIDES = {
  ...
  "set_aa_T2_plate_005:4": "REVIEW BOUNDARY: description says over 50; implementation uses >= 50. Decoded records prove amount 30 but not the operator.",
  "set_aa_leather_003:2": "REVIEW BOUNDARY: description says over 30; implementation uses >= 30. Decoded records prove amount 8% but not the operator.",
  "set_aa_leather_003:4": "REVIEW SOURCE GAP: projected description omits the affected stat; implementation assumes Attack Speed.",
  ...
  "set_aa_T2_fabric_003:2": "REVIEW STACKING: Questlog rule adds personal and party-aura values for self.",
  "set_aa_T2_fabric_003:4": "REVIEW STACKING: Questlog rule adds personal and party-aura values for self.",
  "set_aa_T2_leather_004:2": "REVIEW STACKING: Questlog rule adds personal and party-aura values for self.",
  "set_aa_T2_leather_004:4": "REVIEW STACKING: Questlog rule adds personal and party-aura values for self.",
  "set_aa_T2_plate_003:2": "REVIEW STACKING: Questlog rule applies both personal and party-aura values to self.",
  "set_aa_T2_plate_003:4": "REVIEW STACKING: Questlog rule applies both personal and party-aura values to self.",
};
...
const UNMAPPED_CLASSIFICATION = {
  ...
  "set_aa_T2_leather_005:2": "Mapped 2026-07-13: self component only; party-aura duplication pending in-game read.",
  "set_aa_T2_leather_005:4": "Mapped 2026-07-13: self component only; party-aura duplication pending in-game read.",

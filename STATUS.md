...
| Combat Lab | Simplified Ability Damage and PvP Matchup tools with saved-build prefills, progressive evidence disclosure, reviewed per-hit ranges, and visible-stat contest summaries | `web/combat-lab.html` |
...
- Latest verification gate: BuildSnapshot passed, 69/69 assertions across 3
  fixtures, all 12 edge checks passed, JavaScript tests 184/184, collector tests
  92/92.

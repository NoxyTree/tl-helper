...
function buildResult(selection, projection = {}) {
  ...
  const unresolvedStages = [
    ...
    assumptionStage("coefficient-basis", "The interpretation of 10000 as 100 percent requires in-game confirmation.", ability.gameBuild),
  ...
  const result = {
    ...
    assumptions: projection.magnitudeProjection ? [
      ...
      "The coefficient basis is treated as 10000 = 100 percent by explicit opt-in.",
      ...
      "The expression records the uncalibrated 10000 coefficient basis without executing it.",
    ],
    warnings: [

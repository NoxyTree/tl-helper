export const KIT_ROTATION_MODEL_VERSION = "kit-rotation-2026-07-17.v3";
...
export function modelKitRotationPacket({ skills = [], weaponDamage, autoAttack = null, cooldownSpeed = 0 } = {}) {
  ...
  const assumptions = [
    ...
    "Validated specialization overrides are applied to a skill's primary hit; a chosen specialization without a validated override keeps the skill at its base form and is disclosed, which can understate or overstate that skill's real numbers.",

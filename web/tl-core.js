...
export function statDisplayToRaw(id, value) {
  ...
  if (["all_state_accuracy","all_state_tolerance","bind_accuracy","bind_tolerance","blind_accuracy","blind_tolerance","collide_amplification","collide_resistance","collision_resistance","petrification_accuracy","petrification_tolerance","silence_accuracy","silence_tolerance","sleep_accuracy","sleep_tolerance","stun_accuracy","stun_tolerance","weaken_accuracy","weaken_tolerance"].includes(id)) return numeric * 40;
